  ...
  <div class="app-container">
    ...
    <el-form v-show="showSearch" :inline="true" ref="form" :model="params" label-width="68px">
      <el-form-item label="用户名称">
        <el-input style="width: 200px" size="small" v-model="params.keywords" placeholder="请输入评论或回复人昵称"/>
      </el-form-item>
      <el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <right-toolbar :showSearch.sync="showSearch" @queryTable="fetchComment"></right-toolbar>
    </el-row>
