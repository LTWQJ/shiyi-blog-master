<template>
  <div class="com-skill">
    ...
    <!-- 技能: 肉弹冲击 -->
    <img v-if="skillList[1].isShow" class="skill-rush" src="@/components/protectTheHorse/assets/img/meat-rush.png" alt="">
  </div>
</template>
...
.com-skill {
  .skill-wrap {
    ...
    user-select: none;
    .skill-item {
      @smallSize: calc(@radishSize * 0.8);
      @fontSize: calc(@radishSize * 0.64);
      position: relative;
      margin-right: 15px;
      border-radius: 8px;
  ...
  .skill-boom {
    ...
    width: calc(@radishSize * 8);
    height: calc(@radishSize * 8);
    background: url(../../protectTheHorse/assets/img/boom.png) no-repeat;
